...
def default_config() -> dict[str, Any]:
    ...
    return {
        ...
        "data": {
            ...
            "frames_subdir": "",
            "frames_ext": "jpg",
            "camera_selection": "legacy_exterior_1",
            "allowed_camera_calibration_sources": [],
            "future_horizon": 0,
            ...
            "proprioception": {"enabled": False, "source": "observations", "key": "cartesian_position", "step": "target", "dims": 6, "projection_image_space": "original"},
        },
        "action": {
            "dim": 7,
            "pose_dims": 6,
