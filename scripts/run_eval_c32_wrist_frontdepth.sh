...
CONFIG="${CONFIG:-configs/droidexFULL_C32_wrist_frontdepth_eval32.yaml}"
CHECKPOINT="${1:-${CHECKPOINT:-outputs/droidexFULL_C32_wrist_frontdepth_cont12_lr3e5/latest.pt}}"
if [[ $# -gt 0 ]]; then shift; fi
GPU_ID="${GPU_ID:-0}"
MAX_WINDOWS="${MAX_WINDOWS:-800}"
BATCH_SIZE="${BATCH_SIZE:-32}"
LOG_FILE="${LOG_FILE:-outputs/droidexFULL_C32_wrist_frontdepth_cont12_lr3e5/eval32_800w_seed0.log}"
