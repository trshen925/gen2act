...
CONFIG="${CONFIG:-configs/droidexFULL_C36_no_frontdepth_diffuse_gripper_eval32.yaml}"
CHECKPOINT="${1:-outputs/droidexFULL_C36_no_frontdepth_diffuse_gripper_fulltrain/latest.pt}"
GPU_ID="${GPU_ID:-0}"
MAX_WINDOWS="${MAX_WINDOWS:-800}"
BATCH_SIZE="${BATCH_SIZE:-32}"
LOG_FILE="${LOG_FILE:-outputs/droidexFULL_C36_no_frontdepth_diffuse_gripper_fulltrain/eval32_800w_seed0.log}"
