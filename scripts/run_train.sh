#!/usr/bin/env bash
# One-click training launcher for r2r-gen2act.
...
#   CONFIG defaults to the chunk4 pose6d config below.
set -euo pipefail
...
CONFIG="${1:-configs/droid2000new_future5_chunk4_pose6d_regression_qpos_ft4dinov2_latent128_aug50.yaml}"
shift || true
